package xinmiao.gdkm.weixin.serviceImpl;
...
import xinmiao.gdkm.weixin.domain.ResponseError;
import xinmiao.gdkm.weixin.domain.ResponseMessage;
import xinmiao.gdkm.weixin.domain.ResponseToken;
...
public class AccessTokenManagerSample implements AccessTokenManager {
	...
	private ResponseToken getRemoteToken(String account) {
		String appid = "wx76fc48ebe1258d25"; 
		String appSecret = "21dc4a6a7c050614daeace6f20afecf7";
